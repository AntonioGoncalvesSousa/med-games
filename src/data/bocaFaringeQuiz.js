...
export const bocaFaringeQuestions = [
  ...
  },
  {
    id: 'dentes-incisivos',
    type: 'model',
    modelFile: 'skeleton.glb',
    meshNames: [
      'Upper_medial_incisorl_2', 'Upper_medial_incisorr_2',
      'Upper_lateral_incisorl_2', 'Upper_lateral_incisorr_2',
      'Lower_medial_incisorl_2', 'Lower_medial_incisorr_2',
      'Lower_lateral_incisorl_2', 'Lower_lateral_incisorr_2',
    ],
    question: 'Identifique o grupo de dentes destacado no modelo 3D.',
    answer: 'incisivos',
  },
  {
    id: 'dentes-caninos',
    ...
    modelFile: 'skeleton.glb',
    meshNames: [
      'Upper_caninel_2', 'Upper_caniner_2',
      'Lower_caninel_2', 'Lower_caniner_2',
    ],
    question: 'Identifique o grupo de dentes destacado no modelo 3D.',
    answer: 'caninos',
  },
  {
    id: 'dentes-pre-molares',
    type: 'model',
    modelFile: 'skeleton.glb',
    meshNames: [
      'Upper_first_premolarl_2', 'Upper_first_premolarr_2',
      'Upper_second_premolarl_2', 'Upper_second_premolarr_2',
      'Lower_first_premolarl_2', 'Lower_first_premolarr_2',
      'Lower_second_premolarl_2', 'Lower_second_premolarr_2',
    ],
    question: 'Identifique o grupo de dentes destacado no modelo 3D.',
    answer: 'pré-molares',
  },
  {
    ...
    modelFile: 'skeleton.glb',
    meshNames: [
      'Upper_first_molar_toothl_2', 'Upper_first_molar_toothr_2',
      'Upper_second_molar_toothl_2', 'Upper_second_molar_toothr_2',
      'Lower_first_molar_toothl_2', 'Lower_first_molar_toothr_2',
      'Lower_second_molar_toothl_2', 'Lower_second_molar_toothr_2',
    ],
    question: 'Identifique o grupo de dentes destacado no modelo 3D.',
    answer: 'molares',
  },
